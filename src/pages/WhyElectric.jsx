...
import ItemDescription from "@/components/WhyElectric/ItemDescription";
import WHY_ELECTRIC_DATA from "@/utils/data/whyelectric_data";
    ...
    <Layout>
      {selected===null?<div className="py-8 px-12">
        <div className="text-3xl font-semibold">
          Why you should choose an Electric Vehicle
        </div>
